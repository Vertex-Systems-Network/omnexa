...
The closure is canonical only when this rebuilt exact state is present on protected main. Failed #304 remains historical FAIL evidence and grants no merge authority.
