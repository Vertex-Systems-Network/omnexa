...
Reuse exactly one repository ledger named `omnexa — Scheduled AI Development Report`, except where an existing repository-specific historical ledger is explicitly designated as canonical. Append history; never overwrite prior report rows.
