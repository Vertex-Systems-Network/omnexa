...
> **Current transition candidate:** **P04 — Data, Jobs & Event Fabric: 3 / 10 done; P04.04 Transactional Outbox Reliability Primitive is the sole candidate ACTIVE package.** This becomes canonical only after exact-head Governance, unchanged promotion, protected merge and protected-main read-back.

`docs/roadmap/STATE.json` remains the canonical machine-readable execution cursor. README status is a human-readable mirror and never grants authority by itself.

## Project progress dashboard

Phase-count view: **4 of 28 phases completed**, with **P04 active**. Current P04 accepted-package progress is **3 / 10 (30%)**. The phase count is only a roadmap-position indicator; canonical implementation progress is based on accepted work packages, not subjective effort.
...
| P04 | Data, Jobs & Event Fabric | 🟡 ACTIVE | 3/10 (30%) | `███░░░░░░░` | 2026-08-30 | TBD (active) |
...
**Date semantics:** completed/current phase dates are repository governance dates derived from accepted activation/completion history. Future phase dates are intentionally `TBD`; this roadmap does not invent delivery deadlines before governed planning exists.

## Current P04 package / module status
| Package | Module / Contract | Status | Package progress | Progress | Start date | End date |
|---|---|---:|---:|---|---|---|
...
| P04.04 | Transactional outbox reliability primitive | 🟡 ACTIVE | 0% runtime implementation (activation only) | `░░░░░░░░░░` | 2026-09-01 (candidate) | TBD |
...
P04.04 activation does **not** include runtime implementation. After the activation transaction is accepted and read back from protected `main`, P04.04 implementation must begin on a fresh separate branch. P04.05-P04.10 remain locked.

## Accepted P04 evidence chain
- **P04.01 — Event Envelope & Identity Contract:** DONE with retained completion evidence.
- **P04.02 — Publish/Subscribe Abstraction & Ownership Boundaries:** DONE with retained completion evidence.
