...
if state.get("current_phase") not in {"P01", "P02", "P03", "P04"}:
    raise SystemExit("ERROR: completed P01 validator must be reviewed before advancing beyond P04")
...
if state.get("current_phase") == "P01":
    ...
    raise SystemExit("ERROR: business-feature implementation must remain locked in P02/P03/P04")
